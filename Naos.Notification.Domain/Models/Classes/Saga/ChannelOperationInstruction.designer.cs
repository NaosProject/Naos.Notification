...
namespace Naos.Notification.Domain
{
    ...
    [Serializable]
    public partial class ChannelOperationInstruction : IModel<ChannelOperationInstruction>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ChannelOperationInstruction"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(ChannelOperationInstruction left, ChannelOperationInstruction right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ChannelOperationInstruction"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ChannelOperationInstruction left, ChannelOperationInstruction right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(ChannelOperationInstruction other)
        {
            ...
            var result = this.Operation.IsEqualTo(other.Operation)
                      && this.MonitoringInfo.IsEqualTo(other.MonitoringInfo)
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ChannelOperationInstruction);

        /// <inheritdoc />
        public override int GetHashCode() => HashCodeHelper.Initialize()
            .Hash(this.Operation)
            .Hash(this.MonitoringInfo)
            .Hash(this.Tags)
            .Value;
        ...
        /// <returns>New <see cref="ChannelOperationInstruction" /> using the specified <paramref name="operation" /> for <see cref="Operation" /> and a deep clone of every other property.</returns>
        ...
        /// <summary>
        /// Deep clones this object with a new <see cref="MonitoringInfo" />.
        /// </summary>
        /// <param name="monitoringInfo">The new <see cref="MonitoringInfo" />.  This object will NOT be deep cloned; it is used as-is.</param>
        /// <returns>New <see cref="ChannelOperationInstruction" /> using the specified <paramref name="monitoringInfo" /> for <see cref="MonitoringInfo" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        /// <returns>New <see cref="ChannelOperationInstruction" /> using the specified <paramref name="tags" /> for <see cref="Tags" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        {
            var result = Invariant($"Naos.Notification.Domain.ChannelOperationInstruction: Operation = {this.Operation?.ToString() ?? "<null>"}, MonitoringInfo = {this.MonitoringInfo?.ToString() ?? "<null>"}, Tags = {this.Tags?.ToString() ?? "<null>"}.");
