    ...
    public partial class PrepareToSendNotificationResult : IModel<PrepareToSendNotificationResult>
    {
        ...
        public PrepareToSendNotificationResult DeepClone()
        {
            var result = new PrepareToSendNotificationResult(
                                 this.ChannelToPrepareToSendOnChannelResultMap?.ToDictionary(k => (IDeliveryChannel)DeepCloneInterface(k.Key), v => v.Value?.DeepClone()),
                                 this.CannotPrepareToSendOnChannelAction,
                                 this.ChannelsToSendOn?.Select(i => (IDeliveryChannel)DeepCloneInterface(i)).ToList());
