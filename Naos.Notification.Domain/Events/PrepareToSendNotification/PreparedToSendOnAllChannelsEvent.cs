// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PreparedToSendOnAllChannelsEvent.cs" company="Naos Project">
...
namespace Naos.Notification.Domain
{
    ...
    public partial class PreparedToSendOnAllChannelsEvent : PrepareToSendNotificationEventBase, IModelViaCodeGen
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparedToSendOnAllChannelsEvent"/> class.
        /// </summary>
        ...
        public PreparedToSendOnAllChannelsEvent(
            long id,
            ...
            : base(id, timestampUtc, getAudienceResult, getDeliveryChannelConfigsResult, prepareToSendNotificationResult)
        {
            ...
            new { prepareToSendNotificationOutcome }.AsArg().Must().BeEqualTo(PrepareToSendNotificationOutcome.PreparedToSendOnAllChannels);
        }
    }
}