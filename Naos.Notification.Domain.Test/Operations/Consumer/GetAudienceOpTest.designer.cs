...
namespace Naos.Notification.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetAudienceOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetAudienceOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetAudienceOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetAudienceOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetAudienceOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Notification.Domain.GetAudienceOp: Notification = {systemUnderTest.Notification?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetAudienceOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetAudienceOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAudienceOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'notification' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetAudienceOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetAudienceOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetAudienceOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetAudienceOp>
                {
                    Name = "Notification should return same 'notification' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetAudienceOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetAudienceOp>
                        {
                            SystemUnderTest = new GetAudienceOp(
        ...
        private static readonly DeepCloneWithTestScenarios<GetAudienceOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetAudienceOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAudienceOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAudienceOp>().ThatIs(_ => !systemUnderTest.Notification.IsEqualTo(_.Notification));

                        var result = new SystemUnderTestDeepCloneWithValue<GetAudienceOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetAudienceOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetAudienceOp>();

        private static readonly EquatableTestScenarios<GetAudienceOp> EquatableTestScenarios = new EquatableTestScenarios<GetAudienceOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetAudienceOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetAudienceOp[]
                    {
                        new GetAudienceOp(
                                ReferenceObjectForEquatableTestScenarios.Notification),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetAudienceOp[]
                    {
                        new GetAudienceOp(
                                A.Dummy<GetAudienceOp>().Whose(_ => !_.Notification.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Notification)).Notification),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetAudienceOp___Should_implement_IModel_of_GetAudienceOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetAudienceOp);

                var expectedModelMethods = typeof(IModel<GetAudienceOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetAudienceOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetAudienceOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetAudienceOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetAudienceOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetAudienceOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetAudienceOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetAudienceOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetAudienceOp systemUnderTest1 = null;
                GetAudienceOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetAudienceOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_GetAudienceResult___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<GetAudienceResult> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<GetAudienceResult>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_GetAudienceResult___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<GetAudienceResult>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_GetAudienceResult___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAudienceResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_GetAudienceResult___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAudienceResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_GetAudienceResult___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAudienceResult>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAudienceOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAudienceOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAudienceOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAudienceOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAudienceOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
