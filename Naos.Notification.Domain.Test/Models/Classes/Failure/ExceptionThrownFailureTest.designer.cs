...
namespace Naos.Notification.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ExceptionThrownFailure> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ExceptionThrownFailure>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ExceptionThrownFailure>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ExceptionThrownFailure>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ExceptionThrownFailure>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Notification.Domain.ExceptionThrownFailure: ExceptionToString = {systemUnderTest.ExceptionToString?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ExceptionThrownFailure> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ExceptionThrownFailure>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ExceptionThrownFailure>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ExceptionThrownFailure> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ExceptionThrownFailure>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ExceptionThrownFailure>
                {
                    Name = "ExceptionToString should return same 'exceptionToString' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<ExceptionThrownFailure>();

                        var result = new SystemUnderTestExpectedPropertyValue<ExceptionThrownFailure>
                        {
                            SystemUnderTest = new ExceptionThrownFailure(
        ...
        private static readonly DeepCloneWithTestScenarios<ExceptionThrownFailure> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ExceptionThrownFailure>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ExceptionThrownFailure>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ExceptionThrownFailure>().ThatIs(_ => !systemUnderTest.ExceptionToString.IsEqualTo(_.ExceptionToString));

                        var result = new SystemUnderTestDeepCloneWithValue<ExceptionThrownFailure>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ExceptionThrownFailure ReferenceObjectForEquatableTestScenarios = A.Dummy<ExceptionThrownFailure>();

        private static readonly EquatableTestScenarios<ExceptionThrownFailure> EquatableTestScenarios = new EquatableTestScenarios<ExceptionThrownFailure>()
            .AddScenario(() =>
                new EquatableTestScenario<ExceptionThrownFailure>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ExceptionThrownFailure[]
                    {
                        new ExceptionThrownFailure(
                                ReferenceObjectForEquatableTestScenarios.ExceptionToString),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ExceptionThrownFailure[]
                    {
                        new ExceptionThrownFailure(
                                A.Dummy<ExceptionThrownFailure>().Whose(_ => !_.ExceptionToString.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ExceptionToString)).ExceptionToString),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ExceptionThrownFailure___Should_implement_IModel_of_ExceptionThrownFailure___When_reflecting()
            {
                // Arrange
                var type = typeof(ExceptionThrownFailure);

                var expectedModelMethods = typeof(IModel<ExceptionThrownFailure>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ExceptionThrownFailure>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ExceptionThrownFailure___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ExceptionThrownFailure);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ExceptionThrownFailure)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "ExceptionToString" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ExceptionThrownFailure)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ExceptionThrownFailure).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ExceptionThrownFailure>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ExceptionThrownFailure systemUnderTest1 = null;
                ExceptionThrownFailure systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ExceptionThrownFailure systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailureBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    FailureBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((FailureBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailureBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((FailureBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailureBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((FailureBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailureBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((FailureBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_FailureBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((FailureBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExceptionThrownFailure___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExceptionThrownFailure___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExceptionThrownFailure___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExceptionThrownFailure___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ExceptionThrownFailure___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
