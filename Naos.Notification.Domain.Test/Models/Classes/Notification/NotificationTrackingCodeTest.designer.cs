...
namespace Naos.Notification.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NotificationTrackingCode> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NotificationTrackingCode>();

        private static readonly ConstructorArgumentValidationTestScenarios<NotificationTrackingCode> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NotificationTrackingCode>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<NotificationTrackingCode> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NotificationTrackingCode>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NotificationTrackingCode>
                {
                    Name = "Id should return same 'id' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NotificationTrackingCode>();

                        var result = new SystemUnderTestExpectedPropertyValue<NotificationTrackingCode>
                        {
                            SystemUnderTest = new NotificationTrackingCode(
                                                      referenceObject.Id),
        ...
        private static readonly DeepCloneWithTestScenarios<NotificationTrackingCode> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NotificationTrackingCode>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NotificationTrackingCode>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NotificationTrackingCode>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<NotificationTrackingCode>
                        {
        ...
        private static readonly NotificationTrackingCode ReferenceObjectForEquatableTestScenarios = A.Dummy<NotificationTrackingCode>();

        private static readonly EquatableTestScenarios<NotificationTrackingCode> EquatableTestScenarios = new EquatableTestScenarios<NotificationTrackingCode>()
            .AddScenario(() =>
                new EquatableTestScenario<NotificationTrackingCode>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NotificationTrackingCode[]
                    {
                        new NotificationTrackingCode(
                                ReferenceObjectForEquatableTestScenarios.Id),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NotificationTrackingCode[]
                    {
                        new NotificationTrackingCode(
                                A.Dummy<NotificationTrackingCode>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id),
                    },
        ...
        public static class Structural
        {
            ...
            public static void NotificationTrackingCode___Should_implement_IModel_of_NotificationTrackingCode___When_reflecting()
            {
                // Arrange
                var type = typeof(NotificationTrackingCode);

                var expectedModelMethods = typeof(IModel<NotificationTrackingCode>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NotificationTrackingCode>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NotificationTrackingCode___Should_declare_ToString_method___When_reflecting()
            {
                // Arrange
                var expected = typeof(NotificationTrackingCode);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NotificationTrackingCode___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NotificationTrackingCode);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NotificationTrackingCode)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NotificationTrackingCode)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NotificationTrackingCode).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NotificationTrackingCode>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NotificationTrackingCode systemUnderTest1 = null;
                NotificationTrackingCode systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NotificationTrackingCode systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NotificationTrackingCode___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NotificationTrackingCode___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NotificationTrackingCode___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NotificationTrackingCode___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NotificationTrackingCode___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
