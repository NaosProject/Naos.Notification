...
namespace Naos.Notification.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeliveryChannelConfig> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeliveryChannelConfig>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeliveryChannelConfig>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeliveryChannelConfig>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DeliveryChannelConfig>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Notification.Domain.DeliveryChannelConfig: Channel = {systemUnderTest.Channel?.ToString() ?? "<null>"}, Action = {systemUnderTest.Action.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeliveryChannelConfig> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeliveryChannelConfig>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DeliveryChannelConfig> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeliveryChannelConfig>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeliveryChannelConfig>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DeliveryChannelConfig>
                        {
                            SystemUnderTest = new DeliveryChannelConfig(
        ...
        private static readonly DeepCloneWithTestScenarios<DeliveryChannelConfig> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeliveryChannelConfig>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeliveryChannelConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeliveryChannelConfig>().ThatIs(_ => !systemUnderTest.Channel.IsEqualTo(_.Channel));

                        var result = new SystemUnderTestDeepCloneWithValue<DeliveryChannelConfig>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeliveryChannelConfig>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeliveryChannelConfig>().ThatIs(_ => !systemUnderTest.Action.IsEqualTo(_.Action));
        ...
        private static readonly DeliveryChannelConfig ReferenceObjectForEquatableTestScenarios = A.Dummy<DeliveryChannelConfig>();

        private static readonly EquatableTestScenarios<DeliveryChannelConfig> EquatableTestScenarios = new EquatableTestScenarios<DeliveryChannelConfig>()
            .AddScenario(() =>
                new EquatableTestScenario<DeliveryChannelConfig>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeliveryChannelConfig[]
                    {
                        new DeliveryChannelConfig(
                                ReferenceObjectForEquatableTestScenarios.Channel,
                                ReferenceObjectForEquatableTestScenarios.Action),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DeliveryChannelConfig[]
                    {
                        new DeliveryChannelConfig(
                                A.Dummy<DeliveryChannelConfig>().Whose(_ => !_.Channel.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Channel)).Channel,
                                ReferenceObjectForEquatableTestScenarios.Action),
                        new DeliveryChannelConfig(
                                ReferenceObjectForEquatableTestScenarios.Channel,
                                A.Dummy<DeliveryChannelConfig>().Whose(_ => !_.Action.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Action)).Action),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DeliveryChannelConfig___Should_implement_IModel_of_DeliveryChannelConfig___When_reflecting()
            {
                // Arrange
                var type = typeof(DeliveryChannelConfig);

                var expectedModelMethods = typeof(IModel<DeliveryChannelConfig>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeliveryChannelConfig>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DeliveryChannelConfig___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DeliveryChannelConfig);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeliveryChannelConfig)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Channel == null)
                {
                    actual.Channel.AsTest().Must().BeNull();
                }
                else if (!actual.Channel.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Channel.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Channel);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Channel", "Action" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeliveryChannelConfig)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeliveryChannelConfig).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeliveryChannelConfig>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeliveryChannelConfig systemUnderTest1 = null;
                DeliveryChannelConfig systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeliveryChannelConfig systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeliveryChannelConfig___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeliveryChannelConfig___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeliveryChannelConfig___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeliveryChannelConfig___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeliveryChannelConfig___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
