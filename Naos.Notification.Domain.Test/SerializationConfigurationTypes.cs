...
namespace Naos.Notification.Domain.Test
{
    ...
    {
        public static BsonSerializationConfigurationType BsonSerializationConfigurationType => typeof(NotificationBsonSerializationConfiguration).ToBsonSerializationConfigurationType();

        public static JsonSerializationConfigurationType JsonSerializationConfigurationType => typeof(NotificationJsonSerializationConfiguration).ToJsonSerializationConfigurationType();
    }
}